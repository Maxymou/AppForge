  ...
  return (
    <Modal open={open} onClose={onClose} title="Paramètres" description="Gérez votre compte utilisateur.">
      <div className="space-y-4">
        <div>
          <label className="mb-1.5 block text-xs font-medium uppercase tracking-wide text-content-muted">Nom d'utilisateur</label>
        ...
        <div className="border-t border-border-subtle pt-4">
          ...
          <div className="space-y-2">
            ...
            <Button variant="secondary" onClick={savePassword} disabled={!currentPassword || !newPassword} className="w-full">Modifier le mot de passe</Button>
          </div>
        </div>

        <div className="border-t border-border-subtle pt-4">
          <Button variant="danger" onClick={logout} className="w-full">Se déconnecter</Button>
        </div>
      </div>
    </Modal>
  )
